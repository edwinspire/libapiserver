import { n as noop, d as safe_not_equal, f as now, l as loop, c as create_ssr_component, a as subscribe, e as escape, v as validate_component } from "../../_app/immutable/chunks/index-5d84e3f4.js";
...
<div class="${"file"}"><label class="${"file-label"}"><input class="${"file-input"}" type="${"file"}" name="${"resume"}">
